...
to_fp16_cuda_t ggml_get_to_fp16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_TQ3_1S_PS:
            return dequantize_block_cont_cuda<QK_TQ3_0, QR_TQ3_1S_PS, dequantize_tq3_1s_ps>;
        case GGML_TYPE_TQ3_RVQ:
            convert_sync_tq3_rvq_codebook();
            return dequantize_block_cont_cuda<QK_TQ3_RVQ, QR_TQ3_RVQ, dequantize_tq3_rvq, half>;
        case GGML_TYPE_F32:
            return convert_unary_cont_cuda<float>;
        case GGML_TYPE_BF16:
...
to_fp32_cuda_t ggml_get_to_fp32_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_TQ3_RVQ:
            convert_sync_tq3_rvq_codebook();
            return dequantize_block_cont_cuda<QK_TQ3_RVQ, QR_TQ3_RVQ, dequantize_tq3_rvq, float>;
        case GGML_TYPE_F16:
            return convert_unary_cont_cuda<half>;
        case GGML_TYPE_BF16:
            return convert_unary_cont_cuda<nv_bfloat16>;
...
to_fp16_nc_cuda_t ggml_get_to_fp16_nc_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_TQ3_1S_PS:
            return dequantize_block_cuda<QK_TQ3_0, QR_TQ3_1S_PS, dequantize_tq3_1s_ps>;
        case GGML_TYPE_TQ3_RVQ:
            convert_sync_tq3_rvq_codebook();
