...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_TQ3_RVQ       = 45, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TQ3_1S_RIM    = 46, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TQ3_4S        = 47, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TQ3_1S_PS    = 48, // except 1d tensors
